// Taken from https://github.com/Azganoth/tree-sitter-lua/blob/4ee557370d01b99406b4f31f824102b6ea3897a8/src/scanner.cc
...
extern "C" {
  ...
  void *tree_sitter_regent_external_scanner_create() {
    return new Scanner();
  }

  void tree_sitter_regent_external_scanner_destroy(void *payload) {
    Scanner *scanner = static_cast<Scanner *>(payload);
    delete scanner;
  }

  bool tree_sitter_regent_external_scanner_scan(void *payload, TSLexer *lexer, const bool *valid_symbols) {
    Scanner *scanner = static_cast<Scanner *>(payload);
    return scanner->scan(lexer, valid_symbols);
  }

  unsigned tree_sitter_regent_external_scanner_serialize(void *payload, char *buffer) {
    return 0;
  }

  void tree_sitter_regent_external_scanner_deserialize(void *payload, const char *buffer, unsigned length) {}
